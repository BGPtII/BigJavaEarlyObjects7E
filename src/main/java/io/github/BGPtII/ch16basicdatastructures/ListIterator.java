...
/**
 * A list iterator allows access to a position in a linked list. This interface contains a subset of the methods of the
...
public interface ListIterator {
     ...
     * @return whether there is an element after the iterator position
     */
    boolean hasNext();
